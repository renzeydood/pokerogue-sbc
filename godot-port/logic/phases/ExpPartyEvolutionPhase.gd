extends BattlePhase
class_name ExpPartyEvolutionPhase
...
func _init(battle, context: Dictionary, active_turn_token: int) -> void:
	phase_name = "ExpPartyEvolutionPhase"
	_battle = battle
	_context = context
...
func _on_start() -> void:
	...
	var result = _battle._run_exp_party_evolution_phase_state(exp_state, _active_turn_token)
